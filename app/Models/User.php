...
#[Fillable(['organization_id', 'role', 'is_superadmin', 'name', 'email', 'password', 'company_name', 'company_logo', 'company_website', 'company_phone', 'company_email', 'mail_batch_size', 'mail_batch_delay', 'active_template_id'])]
