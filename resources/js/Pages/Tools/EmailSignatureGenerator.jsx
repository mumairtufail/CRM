        ...
        <header className="bg-white border-b border-slate-100 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-bold border border-emerald-100">
                <Sparkles size={11} className="fill-emerald-700" />
                100% Free Tool
              </span>
              <Link
                href="/register"
                className="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg text-xs font-bold transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                Sign up for CRM
              </Link>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col justify-between min-h-[300px]">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap gap-4 justify-end">
                ...
                >
                  {copied ? <Check size={14} className="text-emerald-400 animate-scale" /> : <Copy size={14} />}
                ...
                >
                  {copied ? <Check size={14} className="text-emerald-400" /> : <Sparkles size={14} />}
